...
async def _build_variance(
    ...
    *,
    ...
    try:
        ...
        # FON-54 §2 — a broker NOI claim is stated BEFORE the FF&E replacement
        # reserve; compare it against the actuals document's own before-reserve
        # line, or not at all.
        from ..api.analysis import load_actuals_before_reserve_noi

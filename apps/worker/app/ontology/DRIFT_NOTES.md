...
## 6. Phase 1.3c parity exceptions (`documents._load_critic_inputs`)
...
### 6a. The reach freeze — what the registry WOULD add
...
### 6b. Rules that changed meaning without changing a number
